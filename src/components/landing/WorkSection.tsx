    ...
    return (
        <section ref={sectionRef} id="work" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
            ...
            <div ref={headerRef} className="mb-16 flex items-end justify-between">
                <div>
                    <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-primary">02 / Collections</span>
                    <h2 className="mt-4 font-serif text-5xl md:text-7xl tracking-tight uppercase">CURATED LISTS</h2>
                </div>
                <p className="hidden md:block max-w-xs font-mono text-xs text-muted-foreground text-right leading-relaxed">
                    Explore thematic collections, genre deep-dives, and hand-picked films by our community.
                </p>
            </div>
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                ...
                <h3
                    className={cn(
                        "mt-3 font-serif text-2xl md:text-4xl tracking-tight transition-colors duration-300 uppercase",
