...
export function LandingPricing() {
    ...
    return (
        <section
            ref={sectionRef}
            id="pricing"
            className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12 overflow-hidden border-t border-border/10"
        >
            {/* Minimalist Background Grid (Specific to Section) */}
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none -z-10"
                style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, currentColor 1px, transparent 0)', backgroundSize: '40px 40px' }} />

            <div ref={headerRef} className="mb-24 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mt-6">
                    ...
                    <p className="font-mono text-[11px] text-muted-foreground uppercase tracking-widest max-w-sm leading-relaxed mb-2">
            ...
            <div ref={cardsRef} className="grid md:grid-cols-3 gap-0 border border-border/20 relative z-10">
                {tiers.map((tier, idx) => (
                    <div
                        key={tier.id}
                        className={cn(
